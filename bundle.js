    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(
                App,
                { title: 'Music Feed' },
                React.createElement(Item, { user: 'Codazoda', age: '2h', desc: 'Check this out!', icon: 'image/joel.png', sound: 'audio/horse-neighing.mp3' }),
...
ReactDOM.render(React.createElement(AudioApp, { title: 'Audio App' }), document.getElementById('audio-app'));

},{"../src/app":159,"../src/item":161,"react":158,"react-dom":2}],161:[function(require,module,exports){
// item.js
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'info-line' },
        React.createElement('div', { className: 'icon', style: icon }),
        React.createElement(
          'span',
          { className: 'user' },
          this.props.user
      ...
      React.createElement(
        ...
        React.createElement(
          'audio',
          { controls: true },
          React.createElement('source', { src: this.props.sound, type: 'audio/mpeg' })
        )
      ),
      React.createElement(
        'div',
